        ...
        <ul class="nav navbar-nav">
            ...
            <li class="menu-item-has-children dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                    aria-expanded="false"> <i class="menu-icon fa fa-cogs"></i>categories</a>
                <ul class="sub-menu children dropdown-menu">
                    <li><i class="bi bi-house"></i><a href="{{ route('admin.categories.index') }}">Index</a></li>
                    <li><i class="bi bi-plus-circle"></i> <a href="{{ route('admin.categories.create') }}">Create</a></li>
                    <li><i class="bi bi-trash"></i> <a href="{{ route('admin.categories.index') }}">Trash</a></li>
                </ul>
            </li>
            ...
            <li class="menu-item-has-children dropdown">
                ...
                <ul class="sub-menu children dropdown-menu">
                    ...
                    <li><i class="bi bi-trash"></i> <a href="{{ route('admin.products.index') }}">Trash</a></li>
                </ul>
